...
class kitti_raw_loader(object):
    ...
    def load_image_sequence(self, frames, tgt_idx, seq_length):
        ...
        for o in range(-half_offset, half_offset + 1):
            ...
            curr_img_pil = Image.fromarray(curr_img)
            if o == 0:
            ...
            curr_img_resized = curr_img_pil.resize((self.img_width, self.img_height), Image.ANTIALIAS)
            image_seq.append(curr_img_resized)
